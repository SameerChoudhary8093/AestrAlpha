...
export const ticketTagLine: string =
  "Experience a power-packed tech event with a 24-hour Cybrathon and 5 parallel hands-on workshops led by industry experts.\nJoin innovators, startups, and tech enthusiasts for two days of learning, building, and networking.";
export const ticketDescription: string =
  "6th – 7th February | Suresh Gyan Vihar University (SGVU), Library – 3rd & 4th Floor";
