...
export const SwiftIcon = ({ className, style }: IconProps) => (
    ...
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} style={{ color: '#F05138', ...style }} xmlns="http://www.w3.org/2000/svg">
        <path d="M18.8 2.05C17.72 4.19 16.03 6.01 13.97 7.23c2.39-4.22 6.09-5.91 6.09-5.91-.71-2.92-5.74-1.22-5.74-1.22-3.87 2.2-5.78 6.45-5.32 10.92 0 0-.27.87-.03 1.94-.96-3.82.91-8.52.91-8.52-4.59 2.11-7.07 7.07-5.96 11.96 0 0 .57 1.83.67 2.17.06.2.03.38.03.38s-4.66-3.51-3.66-9.13C-.19 11.88-2.6 19.34 6.75 22.25c6.33 1.96 12.82-1.92 13.56-8.56.09-.79.05-1.57-.1-2.31-.69 2.52-1.92 4.67-4.14 6.45 2.15-2.22 3.12-5.4 3.01-8.48 1.88 2.92 1.34 6.01 1.34 6.01.69-2.97-.24-5.9-1.34-8.59 1.98 2.54 2.17 5.76 2.17 5.76.81-3.56-2.45-10.48-2.45-10.48z" />
    </svg>
);
