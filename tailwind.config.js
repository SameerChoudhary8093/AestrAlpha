module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        "small-subheading": "var(--small-subheading-font-family)",
        ...
        "text-regular-semibold": "var(--text-regular-semibold-font-family)",
        "text-small-link": "var(--text-small-link-font-family)",
        "text-small-normal": "var(--text-small-normal-font-family)",
        "text-small-semibold": "var(--text-small-semibold-font-family)",
        sans: [
          "ui-sans-serif",
          "system-ui",
          "sans-serif",
